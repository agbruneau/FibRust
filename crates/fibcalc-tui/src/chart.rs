...
mod tests {
    ...
    fn render_progress_single_algorithm() {
        let algos = vec!["FastDoubling".to_string()];
    ...
    fn render_progress_small_area() {
        let algos = vec!["FastDoubling".to_string(), "Matrix".to_string()];
    ...
    fn render_progress_many_algorithms_small_height() {
        ...
        let algos: Vec<String> = (0..10).map(|i| format!("Algo{i}")).collect();
